    ...
    <div className="pt-8">
      ...
      {loading ? (
        <div className="card p-16 text-center animate-fade-in">
          ...
          <p className="text-[13px] text-[var(--color-text-muted)] mt-4">Loading pipeline...</p>
        </div>
      ) : leads.length === 0 ? (
        <div className="card p-16 text-center animate-fade-up">
          <div
            className="w-12 h-12 rounded-2xl bg-[var(--color-surface-inset)] flex items-center justify-center mx-auto mb-4"
